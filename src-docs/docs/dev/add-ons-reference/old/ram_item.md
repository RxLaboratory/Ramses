...
| **getCurrentStatus**<br />▹ *RamStatus* | *RamStep* or *string*: **step**<br />*string*: **resource** = `""` | |
...
| **getStepHistory**<br />▹ *list of RamStatus* | *RamStep* or *string*: **step**<br />*string*: **resource** = `""` | Gets the history of statuses for a given step and resource. |
